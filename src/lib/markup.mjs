...
export function pageMarkup() {
  return `
    ...
    <header class="site-header">
      <a class="brand" href="#" data-action="replay" aria-label="Revuelto experience, back to beginning">${mark}<span>LAMBORGHINI<small>AN INDEPENDENT 3D EXPERIENCE</small></span></a>
    ...
    <main>
      <section class="assembly-track" id="assembly" aria-label="Scroll-driven Revuelto assembly">
        <div class="stage">
          ...
          <div class="fallback-image" aria-hidden="true"><img src="/images/reference.webp" alt=""/><span>STATIC VISUAL REFERENCE · 3D UNAVAILABLE</span></div>
          <div class="stage-vignette" aria-hidden="true"></div>
          <div class="scene-coordinate mono" aria-hidden="true"><span>STUDIO / 001</span><span>SANT’AGATA BOLOGNESE, ITALY</span></div>
          <div class="hero-copy" data-intro>
            <p class="eyebrow"><span class="live-dot"></span> THE ART OF BECOMING</p>
      ...
      <section class="specifications" aria-label="Manufacturer's published Revuelto specifications"><div class="spec-intro"><p class="eyebrow">LAMBORGHINI REVUELTO</p><h2>A DIFFERENT<br>KIND OF <em>POWER.</em></h2></div><dl class="spec-grid"><div><dt>COMBINED POWER</dt><dd>1,015<small>CV</small></dd></div><div><dt>0–100 KM/H</dt><dd>2.5<small>SECONDS</small></dd></div><div><dt>MAXIMUM SPEED</dt><dd>&gt;350<small>KM/H</small></dd></div></dl><a class="spec-source" href="${MODEL.official}" target="_blank" rel="noopener noreferrer">Manufacturer specifications ${arrow}</a></section>
      <section class="design-section" id="design" aria-labelledby="design-title"><div class="design-heading"><div><p class="eyebrow"><span class="red-rule"></span> THE DESIGN DNA</p><h2 id="design-title">NOT MADE<br>TO <span class="outline">BLEND IN.</span></h2></div><p>A silhouette you recognise before you see the badge. A study in sharp lines, deep contrasts, and unapologetic presence.</p></div><figure class="design-image"><img src="/images/reference.webp" alt="Supplied visual reference: a red and black Lamborghini with sculpted bodywork in a concrete showroom" loading="lazy" width="768" height="432"/><figcaption><span>ROSSO / CARBON — VISUAL DIRECTION</span><span>REFERENCE IMAGE · CUSTOM BODYWORK</span></figcaption></figure><div class="design-notes"><article><span class="note-number">01 /</span><h3>SCULPTED, NOT DECORATED.</h3><p>Red surfaces against deep carbon tones. A presentation finish inspired by the supplied reference.</p></article><article><span class="note-number">02 /</span><h3>EVERY DETAIL, A PURPOSE.</h3><p>Explore the free model’s real component geometry. Scroll forward to build, or backward to take it apart.</p></article><article><span class="note-number">03 /</span><h3>YOUR PERSPECTIVE.</h3><p>Step out of the cinematic camera path. Inspect the assembled car, change its finish, and explore its parts.</p></article></div></section>
      <section class="closing"><p class="eyebrow">NOTHING EXTRAORDINARY HAPPENS BY ACCIDENT.</p><h2>EXPERIENCE IT.<br><span class="outline">ALL OVER AGAIN.</span></h2><button type="button" class="primary-button" data-action="replay">BACK TO THE BEGINNING ${replay}</button></section>
    </main>
